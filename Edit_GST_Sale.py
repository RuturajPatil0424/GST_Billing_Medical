...
class saleClass(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.no1_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno1var,
                                                        values=self.ik1, command=self.itemshow)
        self.no1_unit_entry.grid(row=2, column=3, padx=5, pady=5)
        self.iuno1var.trace('w', self.itemunit_update1)

        self.no2_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno2var,
                                                        values=self.ik2, command=self.itemshow)
        self.no2_unit_entry.grid(row=3, column=3, padx=5, pady=5)
        self.iuno2var.trace('w', self.itemunit_update2)

        self.no3_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno3var,
                                                        values=self.ik3, command=self.itemshow)
        self.no3_unit_entry.grid(row=4, column=3, padx=5, pady=5)
        self.iuno3var.trace('w', self.itemunit_update3)

        self.no4_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno4var,
                                                        values=self.ik4, command=self.itemshow)
        self.no4_unit_entry.grid(row=5, column=3, padx=5, pady=5)
        self.iuno4var.trace('w', self.itemunit_update4)

        self.no5_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno5var,
                                                        values=self.ik5, command=self.itemshow)
        self.no5_unit_entry.grid(row=6, column=3, padx=5, pady=5)
        self.iuno5var.trace('w', self.itemunit_update5)

        self.no6_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno6var,
                                                        values=self.ik6, command=self.itemshow)
        self.no6_unit_entry.grid(row=7, column=3, padx=5, pady=5)
        self.iuno6var.trace('w', self.itemunit_update6)

        self.no7_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno7var,
                                                        values=self.ik7, command=self.itemshow)
        self.no7_unit_entry.grid(row=8, column=3, padx=5, pady=5)
        self.iuno7var.trace('w', self.itemunit_update7)

        self.no8_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno8var,
                                                        values=self.ik8, command=self.itemshow)
        self.no8_unit_entry.grid(row=9, column=3, padx=5, pady=5)
        self.iuno8var.trace('w', self.itemunit_update8)

        self.no9_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno9var,
                                                        values=self.ik9, command=self.itemshow)
        self.no9_unit_entry.grid(row=10, column=3, padx=5, pady=5)
        self.iuno9var.trace('w', self.itemunit_update9)

        self.no10_unit_entry = customtkinter.CTkComboBox(self.navigation_frame, width=100, variable=self.iuno10var,
                                                         values=self.ik10, command=self.itemshow)
        ...
        self.punit_lable = customtkinter.CTkLabel(self.navigation_frame, text="Purchase Price")
        self.punit_lable.grid(row=0, column=4, padx=4, pady=5)

        self.no1_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp1,state="readonly")
        self.no1_p_unitprice_entry.grid(row=2, column=4, padx=5, pady=5)

        self.no2_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp2,state="readonly")
        self.no2_p_unitprice_entry.grid(row=3, column=4, padx=5, pady=5)

        self.no3_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp3,state="readonly")
        self.no3_p_unitprice_entry.grid(row=4, column=4, padx=5, pady=5)

        self.no4_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp4,state="readonly")
        self.no4_p_unitprice_entry.grid(row=5, column=4, padx=5, pady=5)

        self.no5_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp5,state="readonly")
        self.no5_p_unitprice_entry.grid(row=6, column=4, padx=5, pady=5)

        self.no6_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp6,state="readonly")
        self.no6_p_unitprice_entry.grid(row=7, column=4, padx=5, pady=5)

        self.no7_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp7,state="readonly")
        self.no7_p_unitprice_entry.grid(row=8, column=4, padx=5, pady=5)

        self.no8_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp8,state="readonly")
        self.no8_p_unitprice_entry.grid(row=9, column=4, padx=5, pady=5)

        self.no9_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp9,state="readonly")
        self.no9_p_unitprice_entry.grid(row=10, column=4, padx=5, pady=5)

        self.no10_p_unitprice_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ipp10,state="readonly")
        ...
        self.tax_unit_box = customtkinter.CTkComboBox(self.navigation_frame, width=100, values=TaxList,
                                                      command=self.tax)
        ...
        self.Amount_lable = customtkinter.CTkLabel(self.navigation_frame, text="DIS Amount")
        self.Amount_lable.grid(row=0, column=7, padx=5, pady=5)
        ...
        self.DISCOUN_lable.grid(row=0, column=8, padx=5, pady=5)

        self.percentage_lable = customtkinter.CTkLabel(self.navigation_frame, text="%")
        self.percentage_lable.grid(row=1, column=8, padx=5, pady=5)
        ...
        self.no1_tax_percentagee_entry.grid(row=2, column=8, padx=5, pady=5)
        ...
        self.no2_tax_percentagee_entry.grid(row=3, column=8, padx=5, pady=5)
        ...
        self.no3_tax_percentagee_entry.grid(row=4, column=8, padx=5, pady=5)
        ...
        self.no4_tax_percentagee_entry.grid(row=5, column=8, padx=5, pady=5)
        ...
        self.no5_tax_percentagee_entry.grid(row=6, column=8, padx=5, pady=5)
        ...
        self.no6_tax_percentagee_entry.grid(row=7, column=8, padx=5, pady=5)
        ...
        self.no7_tax_percentagee_entry.grid(row=8, column=8, padx=5, pady=5)
        ...
        self.no8_tax_percentagee_entry.grid(row=9, column=8, padx=5, pady=5)
        ...
        self.no9_tax_percentagee_entry.grid(row=10, column=8, padx=5, pady=5)
        ...
        self.no10_tax_percentagee_entry.grid(row=11, column=8, padx=5, pady=5)
        ...
        self.no1_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita1,state="readonly")
        self.no1_tax_amount_entry.grid(row=2, column=9, padx=5, pady=5)

        self.no2_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita2,state="readonly")
        self.no2_tax_amount_entry.grid(row=3, column=9, padx=5, pady=5)

        self.no3_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita3,state="readonly")
        self.no3_tax_amount_entry.grid(row=4, column=9, padx=5, pady=5)

        self.no4_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita4,state="readonly")
        self.no4_tax_amount_entry.grid(row=5, column=9, padx=5, pady=5)

        self.no5_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita5,state="readonly")
        self.no5_tax_amount_entry.grid(row=6, column=9, padx=5, pady=5)

        self.no6_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita6,state="readonly")
        self.no6_tax_amount_entry.grid(row=7, column=9, padx=5, pady=5)

        self.no7_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita7,state="readonly")
        self.no7_tax_amount_entry.grid(row=8, column=9, padx=5, pady=5)

        self.no8_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita8,state="readonly")
        self.no8_tax_amount_entry.grid(row=9, column=9, padx=5, pady=5)

        self.no9_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita9,state="readonly")
        self.no9_tax_amount_entry.grid(row=10, column=9, padx=5, pady=5)

        self.no10_tax_amount_entry = customtkinter.CTkEntry(self.navigation_frame, width=100, textvariable=self.ita10,state="readonly")
        self.no10_tax_amount_entry.grid(row=11, column=9, padx=5, pady=5)

        self.Totaltax_lable = customtkinter.CTkLabel(self.navigation_frame, text=self.diccc)
        self.Totaltax_lable.grid(row=12, column=9, padx=5, pady=5)
    ...
    def add_party_event(self):
        ...
        try:
            if self.partyname_entry.get() == "":
                ...
                con.commit()
                messagebox.showinfo("Success", "Sale Invoice Update Successfully", parent=self)
                #self.add_amount()
        ...
        try:
            if self.partyname_entry.get() == "":
                ...
                if self.cash_switch.get() == 1:
                    ...
                    crstete = "Cash"
                cur.execute(f"Update invogstsale set partyname=?,phonenumber=?,gstin=?,cashorcr=?,invoiceno=?,invoicedate=?,steteofsuply=?,paymentype=?,refreceno=?,total=?,received=?,balance=?,totaltac=?,totaldec=?,totalqty=?,item1name=?,qty1=?,unit1=?,unitprice1=?,dec1=?,desamount1=?,tax1=?,gstamount1=?,amount1=?,item2name=?,qty2=?,unit2=?,unitprice2=?,dec2=?,desamount2=?,tax2=?,gstamount2=?,amount2=?,item3name=?,qty3=?,unit3=?,unitprice3=?,dec3=?,desamount3=?,tax3=?,gstamount3=?,amount3=?,item4name=?,qty4=?,unit4=?,unitprice4=?,dec4=?,desamount4=?,tax4=?,gstamount4=?,amount4=?,item5name=?,qty5=?,unit5=?,unitprice5=?,dec5=?,desamount5=?,tax5=?,gstamount5=?,amount5=?,item6name=?,qty6=?,unit6=?,unitprice6=?,dec6=?,desamount6=?,tax6=?,gstamount6=?,amount6=?,item7name=?,qty7=?,unit7=?,unitprice7=?,dec7=?,desamount7=?,tax7=?,gstamount7=?,amount7=?,item8name=?,qty8=?,unit8=?,unitprice8=?,dec8=?,desamount8=?,tax8=?,gstamount8=?,amount8=?,item9name=?,qty9=?,unit9=?,unitprice9=?,dec9=?,desamount9=?,tax9=?,gstamount9=?,amount9=?,item10name=?,qty10=?,unit10=?,unitprice10=?,dec10=?,desamount10=?,tax10=?,gstamount10=?,amount10=? where sid=1",
                    (
    ...
    def get_data(self):
        ...
        try:
            ...
            cur.execute(
                "select partyname,phonenumber,gstin,cashorcr,invoiceno,invoicedate,steteofsuply,paymentype,refreceno,total,received,balance,item1name,qty1,unit1,unitprice1,dec1,desamount1,tax1,gstamount1,amount1,item2name,qty2,unit2,unitprice2,dec2,desamount2,tax2,gstamount2,amount2,item3name,qty3,unit3,unitprice3,dec3,desamount3,tax3,gstamount3,amount3,item4name,qty4,unit4,unitprice4,dec4,desamount4,tax4,gstamount4,amount4,item5name,qty5,unit5,unitprice5,dec5,desamount5,tax5,gstamount5,amount5,item6name,qty6,unit6,unitprice6,dec6,desamount6,tax6,gstamount6,amount6,item7name,qty7,unit7,unitprice7,dec7,desamount7,tax7,gstamount7,amount7,item8name,qty8,unit8,unitprice8,dec8,desamount8,tax8,gstamount8,amount8,item9name,qty9,unit9,unitprice9,dec9,desamount9,tax9,gstamount9,amount9,item10name,qty10,unit10,unitprice10,dec10,desamount10,tax10,gstamount10,amount10 from editgstsale where sid=?",
                (1,))
            rows = cur.fetchall()
            for row in rows:
                for r in row:
                    items_datalist.append(r)

            self.partyname_entry.set(value=items_datalist[0])
            self.partynumber.set(items_datalist[1])
            self.phonenumber_entry.configure(textvariable=self.partynumber)
            self.gstin.set(items_datalist[2])
            self.gstin_entry.configure(textvariable=self.gstin)
            self.invo.set(items_datalist[4])
            self.invoice_entry.configure(textvariable=self.invo)
            self.date_entry.set_date(items_datalist[5])
            self.statelist.insert(0, items_datalist[6])
            self.state_menu.set(items_datalist[6])
            self.state_menu.configure(values=self.statelist)
            ...
            if items_datalist[4] == "Credit":
                self.cash_switch.select()
            elif items_datalist[4] == "Cash":
                self.cash_switch.deselect()

            self.no1var.set(items_datalist[12])
            self.iq1.set(items_datalist[13])
            self.pastqty1.set(items_datalist[13])
            self.Item_unit_List.insert(0, items_datalist[14])
            self.no1_unit_entry.set(items_datalist[14])
            self.no1_unit_entry.configure(values=self.Item_unit_List)
            self.ip1.set(items_datalist[15])
            self.id1.set(items_datalist[16])
            self.itax1.insert(0, items_datalist[18])
            self.no1_tax_percentagee_entry.configure(values=self.itax1)
            self.no1_tax_percentagee_entry.set(items_datalist[18])

            self.no2var.set(items_datalist[21])
            self.iq2.set(items_datalist[22])
            self.pastqty2.set(items_datalist[22])
            self.Item_unit_List.insert(0, items_datalist[23])
            self.no2_unit_entry.set(items_datalist[23])
            self.no2_unit_entry.configure(values=self.Item_unit_List)
            self.ip2.set(items_datalist[24])
            self.id2.set(items_datalist[25])
            self.itax2.insert(0, items_datalist[27])
            self.no2_tax_percentagee_entry.configure(values=self.itax2)
            self.no2_tax_percentagee_entry.set(items_datalist[27])

            self.no3var.set(items_datalist[30])
            self.iq3.set(items_datalist[31])
            self.pastqty3.set(items_datalist[31])
            self.Item_unit_List.insert(0, items_datalist[32])
            self.no3_unit_entry.set(items_datalist[32])
            self.no3_unit_entry.configure(values=self.Item_unit_List)
            self.ip3.set(items_datalist[33])
            self.id3.set(items_datalist[34])
            self.itax3.insert(0, items_datalist[36])
            self.no3_tax_percentagee_entry.configure(values=self.itax3)
            self.no3_tax_percentagee_entry.set(items_datalist[36])

            self.no4var.set(items_datalist[39])
            self.iq4.set(items_datalist[40])
            self.pastqty4.set(items_datalist[40])
            self.Item_unit_List.insert(0, items_datalist[41])
            self.no4_unit_entry.set(items_datalist[41])
            self.no4_unit_entry.configure(values=self.Item_unit_List)
            self.ip4.set(items_datalist[42])
            self.id4.set(items_datalist[43])
            self.itax4.insert(0, items_datalist[45])
            self.no4_tax_percentagee_entry.configure(values=self.itax4)
            self.no4_tax_percentagee_entry.set(items_datalist[45])

            self.no5var.set(items_datalist[48])
            self.iq5.set(items_datalist[49])
            self.pastqty5.set(items_datalist[49])
            self.Item_unit_List.insert(0, items_datalist[50])
            self.no5_unit_entry.set(items_datalist[50])
            self.no5_unit_entry.configure(values=self.Item_unit_List)
            self.ip5.set(items_datalist[51])
            self.id5.set(items_datalist[52])
            self.itax5.insert(0, items_datalist[54])
            self.no5_tax_percentagee_entry.configure(values=self.itax5)
            self.no5_tax_percentagee_entry.set(items_datalist[54])

            self.no6var.set(items_datalist[57])
            self.iq6.set(items_datalist[58])
            self.pastqty6.set(items_datalist[58])
            self.Item_unit_List.insert(0, items_datalist[59])
            self.no6_unit_entry.set(items_datalist[59])
            self.no6_unit_entry.configure(values=self.Item_unit_List)
            self.ip6.set(items_datalist[60])
            self.id6.set(items_datalist[61])
            self.itax6.insert(0, items_datalist[63])
            self.no6_tax_percentagee_entry.configure(values=self.itax6)
            self.no6_tax_percentagee_entry.set(items_datalist[63])

            self.no7var.set(items_datalist[66])
            self.iq7.set(items_datalist[67])
            self.pastqty7.set(items_datalist[67])
            self.Item_unit_List.insert(0, items_datalist[68])
            self.no7_unit_entry.set(items_datalist[68])
            self.no7_unit_entry.configure(values=self.Item_unit_List)
            self.ip7.set(items_datalist[69])
            self.id7.set(items_datalist[70])
            self.itax7.insert(0, items_datalist[72])
            self.no7_tax_percentagee_entry.configure(values=self.itax7)
            self.no7_tax_percentagee_entry.set(items_datalist[72])

            self.no8var.set(items_datalist[75])
            self.iq8.set(items_datalist[76])
            self.pastqty8.set(items_datalist[76])
            self.Item_unit_List.insert(0, items_datalist[77])
            self.no8_unit_entry.set(items_datalist[77])
            self.no8_unit_entry.configure(values=self.Item_unit_List)
            self.ip8.set(items_datalist[78])
            self.id8.set(items_datalist[79])
            self.itax8.insert(0, items_datalist[81])
            self.no8_tax_percentagee_entry.configure(values=self.itax8)
            self.no8_tax_percentagee_entry.set(items_datalist[81])

            self.no9var.set(items_datalist[84])
            self.iq9.set(items_datalist[85])
            self.pastqty9.set(items_datalist[85])
            self.Item_unit_List.insert(0, items_datalist[86])
            self.no9_unit_entry.set(items_datalist[86])
            self.no9_unit_entry.configure(values=self.Item_unit_List)
            self.ip9.set(items_datalist[87])
            self.id9.set(items_datalist[88])
            self.itax9.insert(0, items_datalist[90])
            self.no9_tax_percentagee_entry.configure(values=self.itax9)
            self.no9_tax_percentagee_entry.set(items_datalist[90])

            self.no10var.set(items_datalist[93])
            self.iq10.set(items_datalist[94])
            self.pastqty10.set(items_datalist[94])
            self.Item_unit_List.insert(0, items_datalist[95])
            self.no10_unit_entry.set(items_datalist[95])
            self.no10_unit_entry.configure(values=self.Item_unit_List)
            self.ip10.set(items_datalist[96])
            self.id10.set(items_datalist[97])
            self.itax10.insert(0, items_datalist[99])
            self.no10_tax_percentagee_entry.configure(values=self.itax10)
            self.no10_tax_percentagee_entry.set(items_datalist[99])
    ...
    def get_item_unit_name(self, name, seto):
        if name == "":
            seto.set("")
        else:
          con = sqlite3.connect(database=r'DataBase/ims.db')
          ...
          try:
            ...
            cur.execute("select unit from itemdata where itemname=?", (name,))
            rows = cur.fetchall()
            # self.productTable.delete(*self.productTable.get_children())
