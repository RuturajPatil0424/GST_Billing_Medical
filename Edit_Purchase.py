...
class saleClass(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.Saleleble = customtkinter.CTkLabel(self, text="Edit Purchase", font=customtkinter.CTkFont(size=25))
        ...
        self.Payment_type_entry = customtkinter.CTkComboBox(self, width=100, values=self.cashlist,command=self.refrance)
        ...
        self.savebtn = customtkinter.CTkButton(self, command=self.savedata, width=80, text="Update Purchase",
