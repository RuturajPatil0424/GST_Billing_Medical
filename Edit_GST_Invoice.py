...
def gatpartyam():
    ...
    try:
        ...
        cur.execute("select partyam, partyamtotal from gstinvopartyam where no=1")
        rows = cur.fetchall()
        for row in rows:
            for i in row:
              partyam.append(i)
...
def get_party_data():
        ...
        try:
            ...
            cur.execute("select pid,name,price,qty,status from editinvogstsale ")
            rows=cur.fetchall()
            for row in rows:
...
def get_partybi_data():
    ...
    try:
        ...
        cur.execute("select partyname,phonenumber,gstin,cashorcr,invoiceno,invoicedate,steteofsuply,paymentype,refreceno,total,received,balance,totaltac,totaldec,totalqty from editeditinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item1_data():
    ...
    try:
        ...
        cur.execute("select item1name,qty1,unit1,unitprice1,dec1,desamount1,tax1,amount1 from editeditinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item2_data():
    ...
    try:
        ...
        cur.execute("select item2name,qty2,unit2,unitprice2,dec2,desamount2,tax2,amount2 from editeditinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item3_data():
    ...
    try:
        ...
        cur.execute("select item3name,qty3,unit3,unitprice3,dec3,desamount3,tax3,amount3 from editeditinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item4_data():
    ...
    try:
        ...
        cur.execute("select item4name,qty4,unit4,unitprice4,dec4,desamount4,tax4,amount4 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item5_data():
    ...
    try:
        ...
        cur.execute("select item5name,qty5,unit5,unitprice5,dec5,desamount5,tax5,amount5 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item6_data():
    ...
    try:
        ...
        cur.execute("select item6name,qty6,unit6,unitprice6,dec6,desamount6,tax6,amount6 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item7_data():
    ...
    try:
        ...
        cur.execute("select item7name,qty7,unit7,unitprice7,dec7,desamount7,tax7,amount7 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item8_data():
    ...
    try:
        ...
        cur.execute("select item8name,qty8,unit8,unitprice8,dec8,desamount8,tax8,amount8 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item9_data():
    ...
    try:
        ...
        cur.execute("select item9name,qty9,unit9,unitprice9,dec9,desamount9,tax9,amount9 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
def get_item10_data():
    ...
    try:
        ...
        cur.execute("select item10name,qty10,unit10,unitprice10,dec10,desamount10,tax10,amount10 from editinvogstsale where sid=1")
        rows=cur.fetchall()
...
filename=f"invoices/{partydata_list[0]}_{partydata_list[2]}_{partydata_list[4]}.pdf"
path=f"invoices/{partydata_list[0]}_{partydata_list[2]}_{partydata_list[4]}.pdf"
convert("DataBase/Invoice/new_sampleinvoice.docx", filename)
