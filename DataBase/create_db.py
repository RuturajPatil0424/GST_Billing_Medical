...
def create_db():
    ...
    # Sale
    cur.execute("CREATE TABLE IF NOT EXISTS sale(sid INTEGER PRIMARY KEY AUTOINCREMENT,partyname text,phonenumber text,gstin text,cashorcr text,invoiceno text,invoicedate text,steteofsuply text,paymentype text,refreceno text,total text,totaldic text,netam text,received text,balance text,item1name text,qty1 text,unit1 text,unitprice1 text,dec1 text,desamount1 text,amount1 text,item2name text,qty2 text,unit2 text,unitprice2 text,dec2 text,desamount2 text,amount2 text,item3name text,qty3 text,unit3 text,unitprice3 text,dec3 text,desamount3 text,amount3 text,item4name text,qty4 text,unit4 text,unitprice4 text,dec4 text,desamount4 text,amount4 text,item5name text,qty5 text,unit5 text,unitprice5 text,dec5 text,desamount5 text,amount5 text,item6name text,qty6 text,unit6 text,unitprice6 text,dec6 text,desamount6 text,amount6 text,item7name text,qty7 text,unit7 text,unitprice7 text,dec7 text,desamount7 text,amount7 text,item8name text,qty8 text,unit8 text,unitprice8 text,dec8 text,desamount8 text,amount8 text,item9name text,qty9 text,unit9 text,unitprice9 text,dec9 text,desamount9 text,amount9 text,item10name text,qty10 text,unit10 text,unitprice10 text,dec10 text,desamount10 text,amount10 text)")
    con.commit()
